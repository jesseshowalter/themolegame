...
-- ============================================================================
-- Bookend + endgame briefings: pre-game OPERATION BRIEFING (round 0), endgame
-- FINAL BRIEFING / VERDICT (round 99) and endgame REVEAL (round 100). Broadcast
-- like mission briefings (mission_status/mission_briefing) but with no quiz
-- questions. See supabase/briefings.sql for details.
-- ============================================================================
...
-- Reveal the mole to everyone, but only once the REVEAL (round 100) is open.
